...
class BookShelf extends Component {
	...
	onUserClicked() {
		this.setState({droppingDown: !this.state.droppingDown})
	}
	...
	render() {
		const { activePage, pageSize, noOfBooks, searchText, username, loggedIn, noOfItemsInCart, droppingDown } = this.state;
		return (
			<div className='BookShelf'>
				<div className='SearchBar'>
					<img className='logo' src={process.env.PUBLIC_URL + "/logo.png"} />
					<input type='text' value={searchText} onChange={this.onSearchTextChange} placeholder="Nhập từ khóa để tìm kiếm" />
					<button className='SeachButton' onClick={this.searchText.bind(this)}>Tìm kiếm</button>
					<div className="Sign">
						...
						{loggedIn && <button onClick={this.onUserClicked.bind(this)} className='SignButton'>
				...
				{droppingDown && <ul className="dropdown">
					<li onClick={this.onHistoryClicked.bind(this)}>Lịch sử đơn hàng</li>
